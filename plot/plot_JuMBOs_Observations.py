...
def read_JuMBOs_Observations(filename="../data/observations/JuMBOs_Observations.csv"):
...
if __name__=="__main__":
    d, m1, m2 = read_JuMBOs_Observations(filename="../data/observations/JuMBOs_Observations.csv")
