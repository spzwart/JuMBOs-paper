...
\begin{table}
 ...
 \hline\hline
model & $n_{(s,j)}$ & $n_{(j,j)}$ & $n_{j}$ & $\langle M \rangle$ & $\langle m \rangle$ & $\langle a \rangle$ & $\langle e \rangle$ \\
        \hline \vspace{-0.75em}\\
...
model & $n_{(s,j)}$ & $n_{(j,j)}$ & $n_{j}$ & $\langle M \rangle$ & $\langle m \rangle$ & $\langle a \rangle$ & $\langle e \rangle$ \\
        \hline \vspace{-0.75em}\\
${\cal SPM}$\_Pl\_R05 && 286.5 &  82.3& 4.19  & 3.24 & 224.9 & 0.21 \\
${\cal SPM}$\_Fr\_R05 &&  61.7 & 113.6& 4.90  & 3.55 & 175.8 & 0.47 \\ 
 \hline
 \end{tabular}
\end{table}
