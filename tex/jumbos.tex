...
${\cal ISF}$\_Fr\_R050 &   $6.7^{+1.5}_{-0.25}$ & $3.6^{+1.6}_{-1.4}$ & $9.4e+01^{+1.2e+02}_{-4.5e+01}$ & $0.59^{+0.14}_{-0.037}$ \\ %Nj=300
${\cal FFC}$\_Fr\_R050 & $7.5^{+3.8}_{-3.6}$ & $2.3^{+1.4}_{-1.1}$ & $3.3e+02^{+2.6e+02}_{-1.4e+02}$ & $0.73^{+0.15}_{-0.24}$ \\ %Nj=1500
